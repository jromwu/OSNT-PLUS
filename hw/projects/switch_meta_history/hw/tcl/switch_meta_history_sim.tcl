...
update_ip_catalog
# packet history
create_ip -name packet_history -vendor NetFPGA -library NetFPGA -module_name packet_history_ip
set_property CONFIG.C_M_AXIS_DATA_WIDTH ${datapath_width_bit} [get_ips packet_history_ip]
set_property CONFIG.C_S_AXIS_DATA_WIDTH ${datapath_width_bit} [get_ips packet_history_ip]
set_property generate_synth_checkpoint false [get_files packet_history_ip.xci]
reset_target all [get_ips packet_history_ip]
generate_target all [get_ips packet_history_ip]
# input_arbiter
