...
module nf_datapath #(
  ...
  //---------------------------------------------------------
  //Extract Metadata
  osnt_extract_metadata_ip  u_osnt_extract_metadata_1 (
      .axis_aclk(axis_aclk),
  ...
  nic_output_port_lookup_ip  u_nic_output_port_lookup_1  (
      .axis_aclk(axis_aclk),
      .axis_resetn(axis_resetn),
  ...
  //PCAP Reply  
  osnt_bram_pcap_replay_uengine_ip  u_osnt_bram_pcap_replay_uengine_1  (
      .axis_aclk(axis_aclk),
      .axis_resetn(axis_resetn),
  ...
  //Inter Packet Delay
  osnt_inter_packet_delay_ip  u_osnt_inter_packet_delay_1  (
      .axis_aclk(axis_aclk),
      .axis_resetn(axis_resetn),
