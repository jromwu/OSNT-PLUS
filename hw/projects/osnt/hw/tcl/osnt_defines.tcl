...
set EXTRACT_METADATA_BASEADDR $M00_BASEADDR
set EXTRACT_METADATA_HIGHADDR $M00_HIGHADDR
set EXTRACT_METADATA_SIZEADDR $M00_SIZEADDR
...
set PCAP_REPLAY_BASEADDR $M02_BASEADDR
set PCAP_REPLAY_HIGHADDR $M02_HIGHADDR
set PCAP_REPLAY_SIZEADDR $M02_SIZEADDR

#INTER_PACKET_DELAY_0 base address and size
set INTER_PACKET_DELAY_0_BASEADDR $M03_BASEADDR
set INTER_PACKET_DELAY_0_HIGHADDR $M03_HIGHADDR
set INTER_PACKET_DELAY_0_SIZEADDR $M03_SIZEADDR

#RATE_LIMITER_0 base address and size
set RATE_LIMITER_0_BASEADDR $M04_BASEADDR
set RATE_LIMITER_0_HIGHADDR $M04_HIGHADDR
set RATE_LIMITER_0_SIZEADDR $M04_SIZEADDR

##OSNT RX Pipeline
#INPUT ARBITER base address and size
set INPUT_ARBITER_BASEADDR $M05_BASEADDR
set INPUT_ARBITER_HIGHADDR $M05_HIGHADDR
set INPUT_ARBITER_SIZEADDR $M05_SIZEADDR

#PKT_CUTTER base address and size
set PKT_CUTTER_BASEADDR $M06_BASEADDR
set PKT_CUTTER_HIGHADDR $M06_HIGHADDR
set PKT_CUTTER_SIZEADDR $M06_SIZEADDR
