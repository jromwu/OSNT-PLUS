...
#M10
set M10_BASEADDR 0x000B0000
set M10_HIGHADDR 0x000B0FFF
set M10_SIZEADDR 0x1000

#M11
set M11_BASEADDR 0x000C0000
set M11_HIGHADDR 0x000C0FFF
...
#INTER_PACKET_DELAY_1 base address and size
set INTER_PACKET_DELAY_1_BASEADDR $M07_BASEADDR
set INTER_PACKET_DELAY_1_HIGHADDR $M07_HIGHADDR
set INTER_PACKET_DELAY_1_SIZEADDR $M07_SIZEADDR

#RATE_LIMITER_0 base address and size
set RATE_LIMITER_0_BASEADDR $M08_BASEADDR
set RATE_LIMITER_0_HIGHADDR $M08_HIGHADDR
set RATE_LIMITER_0_SIZEADDR $M08_SIZEADDR

#RATE_LIMITER_1 base address and size
set RATE_LIMITER_1_BASEADDR $M09_BASEADDR
set RATE_LIMITER_1_HIGHADDR $M09_HIGHADDR
set RATE_LIMITER_1_SIZEADDR $M09_SIZEADDR
