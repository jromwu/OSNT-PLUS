...
if isHW():
    ...
    nftest_regread_expect(NFPLUS_INPUT_ARBITER_0_PKTIN(), 0x400)
    nftest_regread_expect(NFPLUS_INPUT_ARBITER_0_PKTOUT(), 0x400)
    nftest_regread_expect(NFPLUS_OUTPUT_QUEUES_0_PKTSTOREDPORT2(), 0x400)
    nftest_regread_expect(NFPLUS_OUTPUT_QUEUES_0_PKTREMOVEDPORT2(), 0x400) 
    nftest_regread_expect(NFPLUS_OUTPUT_PORT_LOOKUP_0_PKTIN(), 0x400) 
    nftest_regread_expect(NFPLUS_OUTPUT_PORT_LOOKUP_0_PKTOUT(), 0x400) 
    mres=[]
