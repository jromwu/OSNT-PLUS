...
python osnt-tool-cmd.py -new
python osnt-tool-cmd.py -ifp0 ../sample_traces/256.cap -rpn0 100 -ipg0 0 -rxs0 26 -txs0 16
python osnt-tool-cmd.py -ifp1 ../sample_traces/256.cap -rpn1 100 -ipg1 0 -rxs1 26 -txs1 16
