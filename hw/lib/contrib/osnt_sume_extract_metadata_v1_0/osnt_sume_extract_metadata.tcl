...
# Set variables.
set design              osnt_sume_extract_metadata
set ip_version          1.0
...
# IP build.
read_verilog "./hdl/verilog/osnt_sume_extract_metadata.v"
read_verilog "./hdl/verilog/extract_metadata.v"
read_verilog "./hdl/verilog/extract_metadata_cpu_regs_defines.v"
