...
# Set variables.
set design              osnt_sume_bram_pcap_replay_uengine
set ip_version          1.0
...
create_ip -name axis_dwidth_converter -vendor xilinx.com -library ip -version 1.1 -module_name bram_fifo_conv_256to128_0 -dir ./${project_dir}
set_property -dict [list CONFIG.S_TDATA_NUM_BYTES {32} CONFIG.M_TDATA_NUM_BYTES {16} CONFIG.TUSER_BITS_PER_BYTE {8} CONFIG.HAS_TLAST {1} CONFIG.HAS_TKEEP {1}] [get_ips bram_fifo_conv_256to128_0]
generate_target {instantiation_template} [get_files ./${project_dir}/bram_fifo_conv_256to128_0/bram_fifo_conv_256to128_0.xci]
generate_target all [get_files  ./${project_dir}/bram_fifo_conv_256to128_0/bram_fifo_conv_256to128_0.xci]

create_ip -name axis_dwidth_converter -vendor xilinx.com -library ip -version 1.1 -module_name bram_fifo_conv_128to256_0 -dir ./${project_dir}
set_property -dict [list CONFIG.S_TDATA_NUM_BYTES {16} CONFIG.M_TDATA_NUM_BYTES {32} CONFIG.TUSER_BITS_PER_BYTE {8} CONFIG.HAS_TLAST {1} CONFIG.HAS_TKEEP {1}] [get_ips bram_fifo_conv_128to256_0]
generate_target {instantiation_template} [get_files ./${project_dir}/bram_fifo_conv_128to256_0/bram_fifo_conv_128to256_0.xci]
generate_target all [get_files  ./${project_dir}/bram_fifo_conv_128to256_0/bram_fifo_conv_128to256_0.xci]
...
read_verilog "./hdl/verilog/osnt_sume_bram_pcap_replay_uengine.v"
