...
set ip_name 		{pkt_vomiter_mac_attachment}
set lib_name 		{NetFPGA}
set vendor_name 	{NetFPGA}
set ip_display_name 	{pkt_vomiter_mac_attachment}
...
# Top Module Name
set top_module_name {pkt_vomiter_mac_attachment}
...
set_property value_validation_type list [ipx::get_user_parameters C_DEFAULT_VALUE_ENABLE -of_objects [ipx::current_core]]
set_property value_validation_list {0 1} [ipx::get_user_parameters C_DEFAULT_VALUE_ENABLE -of_objects [ipx::current_core]]
set_property value_validation_type list [ipx::get_user_parameters C_RX_TIMESTAMP_ENABLE -of_objects [ipx::current_core]]
set_property value_validation_list {0 1} [ipx::get_user_parameters C_RX_TIMESTAMP_ENABLE -of_objects [ipx::current_core]]
set_property value_validation_type list [ipx::get_user_parameters C_TX_TIMESTAMP_ENABLE -of_objects [ipx::current_core]]
set_property value_validation_list {0 1} [ipx::get_user_parameters C_TX_TIMESTAMP_ENABLE -of_objects [ipx::current_core]]
